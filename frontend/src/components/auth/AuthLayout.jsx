        ...
        () => ({
            ...
            interactivity: {
                ...
                events: {
                    ...
                    onHover: { enable: false, mode: "grab", parallax: { enable: true, force: 60, smooth: 10 } },
            ...
            particles: {
                ...
                links: { blink: false, color: { value: "#ffffff" }, consent: false, distance: 150, enable: true, frequency: 1, opacity: 0.4, shadow: { blur: 5, color: { value: "#000" }, enable: false }, triangles: { enable: false, frequency: 1 }, width: 1, warp: false },
