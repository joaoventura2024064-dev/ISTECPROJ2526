...
function Header() {
    ...
    return (
        <header className="bg-white shadow-[0px_3px_5px_-5px_rgba(0,0,0,0.1),0px_7px_20px_-5px_rgba(0,0,0,0.1)] h-[60px] flex items-center px-10 justify-between sticky top-0 z-50">
